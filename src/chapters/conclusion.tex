...
con Yocto, totalmente funcional, que permite la ejecución y uso de la aplicación embebida.
...
requisitados. La elección de esta aplicación tenía la intención de ser un demostrador y
como tal considero que lo cumple perfectamente.

\paragraph{\checkmark Procesos de testing y deployment de software manuales:}Hemos definido
...
o pragmático. Eso me ha permitido darme cuenta de que las decisiones técnicas sin perspectiva
...
\begin{itemize}
    ...
    no es realmente necesaria, resulta muy conveniente para la construcción automatizada.
    \item Kas puede ser sustituta de ``repo'' y además tiene mucha funcionalidad añadida.
    \item Aunque construir imágenes de Yocto desde cero es increiblemente lento,
    gestionar la caché sstate es vital para evitar compilar de nuevo lo que no cambia de las generaciones
    anteriores.
    ...
    \item Es más cómodo trabajar con un entorno dockerizado de lo que parece, llega
    a ser incluso transparente al usuario, ya que se puede no percibir que se está trabajando
...
fecha límite, cuando esto existe, se puede considerar el trabajo entregado y el proyecto
finalizado. Es posible que en ocasiones el proyecto tenga continuación con otros proyectos
o con ampliaciones del propio proyecto.
También suele haber cierta continuación a modo de soporte, ya que
...
de continuación bajo mi critério estas deberían ser las características a incluir:
...
\begin{itemize}
    ...
    \item Ampliación de las capacidades de la aplicación.
        ...
        \subitem Cambio del tema según se esté de día o de noche.
