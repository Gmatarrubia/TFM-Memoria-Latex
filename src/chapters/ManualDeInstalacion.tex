...
\begin{enumerate}
    ...
    \begin{lstlisting}[style=consola, numbers=left]
        ...
        $ test $(id | grep -c docker) -eq 0 && sudo usermod -aG docker $(whoami)
    \end{lstlisting}
    A continuación será necesario reiniciar para que se haga efectiva la inclusión del
    usuario en el grupo de docker.
...
\subsection{Manera basada en docker:}
